...
/**
 * This method should be used to create iban object from LBR address
 *
 * @method fromAddress
...
Iban.createIndirect = function (options) {
    return Iban.fromBban('LBR' + options.institution + options.identifier);
};
...
Iban.prototype.isValid = function () {
    return /^XE[0-9]{2}(LBR[0-9A-Z]{13}|[0-9A-Z]{30,31})$/.test(this._iban) &&
...
Iban.prototype.isIndirect = function () {
    return this._iban.length === 21;//original 20 for ETH, LBR has 1 char long
};
...
Iban.prototype.institution = function () {
    //ETH to LBR, move the pos from 7 to 8
